...
// ใช้เพื่อดึงข้อมูลเฉพาะ
app.get('/userss', (req, res) => {
    // map คือ การวนลูป array users เพื่อสร้าง array ใหม่ที่มีข้อมูลที่ต้องการ
    ...
    res.json(filterUser); // ส่งข้อมูลที่เก็บใน array users กลับไปยัง client
});
...
app.get('/users/:id', (req, res) => {
    ...
    res.json(filterUser[selectedIndex]); // ส่งข้อมูลที่เก็บใน array users กลับไปยัง client
});

// path = put /user/:id
// put คือการอัพเดทข้อมูลที่มีอยู่แล้ว
...
app.put('/user/:id', (req, res) => {
    ...
    // or
    users[selectedIndex].firstname = updateUser.firstname || users[selectedIndex].firstname ; // อัพเดทชื่อผู้ใช้ หรือใช้ชื่อเดิมถ้าไม่มีการส่งชื่อใหม่มา
    users[selectedIndex].lastname = updateUser.lastname || users[selectedIndex].lastname ; // อัพเดทนามสกุลผู้ใช้ หรือใช้ชื่อเดิมถ้าไม่มีการส่งนามสกุลใหม่มา
    users[selectedIndex].age = updateUser.age || users[selectedIndex].age ; // อัพเดทอายุผู้ใช้ หรือใช้ชื่อเดิมถ้าไม่มีการส่งอายุใหม่มา
    users[selectedIndex].email = updateUser.email || users[selectedIndex].email ; // อัพเดทอีเมลผู้ใช้ หรือใช้ชื่อเดิมถ้าไม่มีการส่งอีเมลใหม่มา
